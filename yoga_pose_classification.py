...
class Model:
    ...
    def build_model(self):
        model = Sequential()
        model.add(Conv2D(16, kernel_size=(3, 3), activation='relu', input_shape=(None, None, 3)))
    ...
    def compile(self):
        ...
        self._model.compile(optimizer=adam, loss='categorical_crossentropy', metrics=['accuracy', 'mae'])
    ...
    def train(self, train_generator, validation_generator, bs=30):
        history = self._model.fit(
            ...
            epochs=10,  # try to increase this and see how it changes
...
cnn_model.save('yoga_poses_cnn_not_resized.h5')
model.save('yoga_poses_cnn.keras')


### PREDICTION ###
# loaded_model = load_model('yoga_poses_cnn_not_resized.h5')
#
# img_path = './goddess_test.jpg'
